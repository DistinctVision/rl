...
class RandomBallGameState(StateSetter):
    ...
    def reset(self, state_wrapper: StateWrapper):
        ...
        rand_ball_pos = np.random.uniform(-2600,  2600, (2,))
        rand_ball_vel = np.random.uniform(-100, 100, (2,))
        
        state_wrapper.ball.set_pos(rand_ball_pos[0], rand_ball_pos[1], 100)
        state_wrapper.ball.set_lin_vel(rand_ball_vel[0], rand_ball_vel[1], 0)
